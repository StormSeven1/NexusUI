...
DDS_RECEIVERS: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "module_file_name": "EntityRealTimeStatus",
   ...
   # === TrackManager转发的DDS航迹（forwardRules） ===
    {
        ...
        "name": "融合航迹(NewTrackStruct)",
        "enabled": True,
        "domain_id": 141,
        "topic_name": "TrackTopic_NewStruct_FuseTrack",
        "profile_name": "track_publisher_forward_NewStruct_FuseTrack",
        "discovery_server_ip": "192.168.18.141",
        "discovery_server_port": 11611,
        "multicast_ip": "239.255.0.1",
        ...
        "data_class_name": "Track",
        "pubsub_type_class_name": "TrackPubSubType",
        "type_name": "Track",
        "use_default_xml": False
    },
    # {
    ...
    # },
    {
        ...
        "name": "对空融合航迹(NewTrackStruct)",
        "enabled": True,
        "domain_id": 141,
        "topic_name": "TrackTopic_NewStruct_FuseBirdRadarTrack",
        "profile_name": "track_publisher_forward_NewStruct_FuseBirdRadarTrack",
        "discovery_server_ip": "192.168.18.141",
        "discovery_server_port": 11611,
        "multicast_ip": "239.255.0.1",
        "multicast_port": 12355,
    ...
    # === 新增DDS配置 ===
    {
        ...
        "profile_name": "dock2_status_subscriber",
        "discovery_server_ip": "192.168.18.141",
        "discovery_server_port": 11611,
        "multicast_ip": "239.255.0.1",
        "multicast_port": 12355,
    ...
    },
    {
        ...
        "profile_name": "drone_status_subscriber",
        "discovery_server_ip": "192.168.18.141",
        "discovery_server_port": 11611,
        "multicast_ip": "239.255.0.1",
        "multicast_port": 12355,
    ...
    },
    {
        ...
        "profile_name": "high_freq_subscriber",
        "discovery_server_ip": "192.168.18.141",
        "discovery_server_port": 11611,
        "multicast_ip": "239.255.0.1",
        "multicast_port": 12355,
    ...
    },
    {
        ...
        "profile_name": "radar_status_subscriber",
        "discovery_server_ip": "192.168.18.141",
        "discovery_server_port": 11611,
        "multicast_ip": "239.255.0.1",
        "multicast_port": 12355,
