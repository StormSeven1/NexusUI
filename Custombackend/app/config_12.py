...
class Settings(BaseSettings):
    ...
    # 服务器配置
    HOST: str = "192.168.28.9"
    PORT: int = 26003
    
    # 本机网络接口IP（用于UDP组播接收）
    LOCAL_INTERFACE: str = "192.168.28.9"
    
    # 数据库配置（仅用于查询区域表）
    DATABASE_HOST: str = "192.168.28.9"
    ...
    ENTITY_PUBLISH_URL: str = "http://192.168.28.9:8090/api/v1/publishEntity"
    ...
    ENTITY_DELETE_URL_TEMPLATE: str = "http://192.168.28.9:8090/api/v1/entities/{entityId}"
...
DDS_RECEIVERS: List[Dict[str, Any]] = [
    {
        ...
        "discovery_server_ip": "192.168.28.9",
...
HTTP_POLLERS: List[Dict[str, Any]] = [
    {
        ...
        "name": "实体状态轮询",
        "url": "http://192.168.28.9:8090/api/v1/entities",
        "method": "GET",
        "poll_interval": 5.0,
        "enabled": True,
    ...
    },
    {
        ...
        "name": "实体关系轮询",
        "url": "http://192.168.28.9:8090/api/v1/relationships",
        "method": "GET",
        "poll_interval": 5.0,
        "enabled": True,
