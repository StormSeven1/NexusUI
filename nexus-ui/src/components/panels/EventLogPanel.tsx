...
const EVENTS: LogEvent[] = [
  { id: "ev01", timestamp: "14:02:41", severity: "critical", category: "threat", source: "系统", message: "TRK-001 进入限制区域 ZONE-ALPHA" },
  { id: "ev02", timestamp: "14:02:40", severity: "info", category: "tracking", source: "雷达 Charlie", message: "TRK-008 轨迹更新：航向 120°，高度 6100ft" },
  { id: "ev03", timestamp: "14:02:39", severity: "critical", category: "detection", source: "雷达 Alpha", message: "新空中目标 TRK-001 首次探测，自动归类为敌方" },
  { id: "ev04", timestamp: "14:02:38", severity: "info", category: "tracking", source: "声呐 A", message: "TRK-004 保持 18kn 航速，朝 315° 持续机动" },
  { id: "ev05", timestamp: "14:02:37", severity: "warning", category: "threat", source: "警戒系统", message: "TRK-004 距警戒水域边界 200m，触发预警" },
  { id: "ev06", timestamp: "14:02:35", severity: "info", category: "tracking", source: "AIS 海岸站", message: "TRK-006 航向变更 315°，偏离预定航路" },
  { id: "ev07", timestamp: "14:02:30", severity: "debug", category: "system", source: "系统", message: "全局态势图刷新完成（周期 5s）" },
  { id: "ev08", timestamp: "14:02:28", severity: "info", category: "tracking", source: "AIS 海岸站", message: "TRK-009 航迹稳定，航向 90°" },
  { id: "ev09", timestamp: "14:02:25", severity: "debug", category: "comm", source: "通信模块", message: "数据链路心跳正常，延迟 12ms" },
  { id: "ev10", timestamp: "14:02:20", severity: "info", category: "detection", source: "雷达 Bravo", message: "TRK-003 进入观察扇区 SECTOR-3" },
  ...
  { id: "ev13", timestamp: "14:00:52", severity: "info", category: "tracking", source: "雷达 Bravo", message: "TRK-003 IFF 应答器确认为友方" },
  { id: "ev14", timestamp: "14:00:30", severity: "info", category: "comm", source: "指挥中心", message: "TRK-005 报告伴随监视任务完成，请求返回基地" },
...
export function EventLogPanel() {
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      {/* 严重程度筛选 */}
      <div className="flex flex-wrap gap-1.5 border-b border-nexus-border px-3 py-2">
        ...
        {filtered.map((event) => {
          ...
          return (
            <div
              key={event.id}
              className={cn(
                "flex items-start gap-2 border-b border-white/[0.03] px-3 py-2 hover:bg-nexus-bg-elevated",
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded bg-nexus-bg-sidebar px-1 py-0.5 text-[9px] font-medium text-nexus-text-muted">
      ...
      {/* 底栏 */}
      <div className="flex items-center justify-between border-t border-nexus-border px-3 py-1.5">
        <button
