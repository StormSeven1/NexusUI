...
export function TrackQualitySection() {
  ...
  return (
    <div className="flex min-h-0 flex-1 gap-2">
      <div className="flex w-[108px] shrink-0 flex-col gap-0.5 overflow-y-auto border-r border-nexus-border pr-1">
        {QUALITY_METRIC_TABS.map((tab) => (
          <button
            ...
            className={cn(
              "rounded-md px-2 py-1.5 text-left text-[10px] leading-snug transition-colors",
              qualityTab === tab.id
