...
const QUICK_WORKFLOWS: QuickWorkflowItem[] = [
  ...
  { id: "auto_duty_workflow-quick-1", name: "自主值班", description: "24小时自主值班查证", workflow_name: "auto_duty_workflow", default_parameters: { schema_id: "SCHEME_A753403E" }, required_parameters: ["schema_id"], icon: "duty", order: 6, enabled: true },
